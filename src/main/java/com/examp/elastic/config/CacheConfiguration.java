package com.examp.elastic.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.examp.elastic.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.examp.elastic.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.examp.elastic.domain.User.class.getName());
            createCache(cm, com.examp.elastic.domain.Authority.class.getName());
